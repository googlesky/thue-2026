  ...
  return (
    <div className="card">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Tính thuế GTGT (VAT)</h2>
      ...
      {isReducedPeriod && (
        <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
          <div className="flex items-start gap-2">
            ...
            <div>
              <h4 className="font-semibold text-green-800 dark:text-green-200">Đang áp dụng giảm VAT 2%</h4>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 border-b dark:border-gray-700 pb-2">
            Thông tin tính thuế
          </h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <div className="text-sm font-medium text-gray-900 dark:text-white">Khấu trừ</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Đầu ra - Đầu vào</div>
              </button>
              <button
              ...
              >
                <div className="text-sm font-medium text-gray-900 dark:text-white">Trực tiếp</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">% trên doanh thu</div>
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-2">
              <label className="flex items-center gap-2">
                ...
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Hiện tại</span>
              </label>
              <label className="flex items-center gap-2">
                <input
                  type="radio"
                  ...
                  className="text-green-600"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Tùy chọn</span>
              </label>
            </div>
            {!useCurrentDate && (
              <input
        ...
        <div className="space-y-5">
          ...
          {result && (
            <>
              ...
              <div className="rounded-lg p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">Phương pháp áp dụng</div>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h4 className="font-semibold text-green-900 dark:text-green-100">Chi tiết tính thuế</h4>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Doanh thu (chưa VAT):</span>
                    <span className="font-medium text-gray-900 dark:text-white">{formatCurrency(salesRevenue)}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {method === 'deduction' && (
                    <>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Giá trị mua vào:</span>
                        <span className="font-medium text-gray-900 dark:text-white">{formatCurrency(purchaseValue)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">
              ...
              {/* VAT Payable */}
              {result.vatPayable > 0 ? (
                <div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-lg p-4 border-2 border-red-300 dark:border-red-700">
                  <div className="flex items-center gap-2 mb-2">
                    <svg className="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <h4 className="font-semibold text-red-900 dark:text-red-100">VAT phải nộp</h4>
                  </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg p-4 border-2 border-blue-300 dark:border-blue-700">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-blue-900 dark:text-blue-100">VAT được khấu trừ/hoàn</h4>
                  </div>
          ...
          {!result && (
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 text-center border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400">Nhập doanh thu để tính thuế GTGT</p>
            </div>
          )}
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className={`rounded-lg p-4 border-2 ${
              ...
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-semibold text-gray-900 dark:text-white">Phương pháp khấu trừ</h4>
                {comparison.recommendation === 'deduction' && (
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400">VAT đầu ra:</span>
                  <span>{formatCurrency(comparison.deduction.outputVAT)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400">VAT đầu vào:</span>
            ...
            <div className={`rounded-lg p-4 border-2 ${
              ...
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-semibold text-gray-900 dark:text-white">Phương pháp trực tiếp</h4>
                {comparison.recommendation === 'direct' && (
                  <span className="px-2 py-1 text-xs bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300 rounded">
                    Đề xuất
                  </span>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
              <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">0% - Xuất khẩu</h4>
            ...
            <div className="rounded-lg p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
              <h4 className="font-semibold text-green-800 dark:text-green-200 mb-2">5% - Hàng thiết yếu</h4>
              <ul className="text-sm text-green-700 dark:text-green-300 space-y-1 columns-2 gap-4">
            ...
            {/* Không chịu thuế */}
            <div className="rounded-lg p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
              <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Không chịu thuế</h4>
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 columns-2 gap-4">
            ...
            <div className="flex items-center gap-2 mb-3">
              {refundCheck.isEligible ? (
                <>
                  ...
                  <span className="font-semibold text-green-800 dark:text-green-200">Đủ điều kiện hoàn thuế</span>
                </>
              ) : (
                <>
                  ...
                  <span className="font-semibold text-amber-800 dark:text-amber-200">Chưa đủ điều kiện</span>
                </>
              )}
            </div>
            <p className={`text-sm mb-3 ${
              refundCheck.isEligible ? 'text-green-700 dark:text-green-300' : 'text-amber-700 dark:text-amber-300'
            }`}>
              {refundCheck.reason}
            </p>
            {refundCheck.isEligible && (
            ...
            <div className="space-y-2">
              {refundCheck.conditions.map((cond, i) => (
                <div key={i} className="flex items-start gap-2 text-sm">
                  ...
                  <div>
                    <div className={cond.met ? 'text-green-700 dark:text-green-300' : 'text-gray-600 dark:text-gray-400'}>
                      {cond.condition}
                    </div>
                    <div className="text-xs text-gray-500 dark:text-gray-500">{cond.description}</div>
                  </div>
                </div>
              ))}
            </div>
